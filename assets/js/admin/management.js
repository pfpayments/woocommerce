...
jQuery(function($) {
	...
	init : function() {
	    ...
	    $('#woocommerce-order-items').on('click.woo-postfinancecheckout',
	...
	show_completion : function(event) {
	    ...
	    $('div.wc-order-add-item').children(
		    'button.postfinancecheckout-completion-button').each(
		    function(key, value) {
			$(value).show();
	    ...
	    $('#woocommerce-order-items').find('input.line_total').each(
			...
			$(this).closest('td.line_cost').find(
				...
				'postfinancecheckout-initial-amount', $(this).val());
	    ...
	    $('#woocommerce-order-items').find('input.line_tax').each(
			...
			$(this).closest('td.line_tax').find(
				...
				'postfinancecheckout-initial-tax', $(this).val());
		    });
