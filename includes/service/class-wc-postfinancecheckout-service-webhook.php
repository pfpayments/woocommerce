...
class WC_PostFinanceCheckout_Service_Webhook extends WC_PostFinanceCheckout_Service_Abstract {
	...
	public function __construct() {
		$this->webhook_entities[1487165678181] = new WC_PostFinanceCheckout_Webhook_Entity(
			1487165678181,
			'Manual Task',
			array(
		...
		$this->webhook_entities[1472041857405] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041857405,
		...
		$this->webhook_entities[1472041829003] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041829003,
			'Transaction',
			array(
		...
		$this->webhook_entities[1472041819799] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041819799,
			'Delivery Indication',
			array(
		...
		$this->webhook_entities[1472041816898] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041816898,
			'Transaction Invoice',
			array(
		...
		$this->webhook_entities[1472041831364] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041831364,
		...
		$this->webhook_entities[1472041867364] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041867364,
			'Transaction Void',
			array(
		...
		$this->webhook_entities[1472041839405] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041839405,
			'Refund',
			array(
		...
		$this->webhook_entities[1472041806455] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041806455,
			'Token',
			array(
				\PostFinanceCheckout\Sdk\Model\CreationEntityState::ACTIVE,
		...
		$this->webhook_entities[1472041811051] = new WC_PostFinanceCheckout_Webhook_Entity(
			1472041811051,
			'Token Version',
			array(
