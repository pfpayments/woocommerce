...
class WC_PostFinanceCheckout_Admin_Transaction {
	...
	public static function add_meta_box(){
		...
		if ($transaction_info->get_id() != null) {
			add_meta_box('woocommerce-order-postfinancecheckout-transaction', __('PostFinance Checkout Transaction', 'woocommerc-postfinancecheckout'), 
					array(
						__CLASS__,
						'output' 
...
<div class="order-postfinancecheckout-transaction-metabox wc-metaboxes-wrapper">
	<div class="postfinancecheckout-transaction-data-column-container">
		<div class="postfinancecheckout-transaction-column">
			<p>
				<strong><?php _e('General Details', 'woo-postfinancecheckout'); ?></strong>
			</p>
            ...
            <?php endif; ?>
            	<tr>
						<td class="label"><label><?php _e('Authorization Amount', 'woo-postfinancecheckout') ?></label></td>
