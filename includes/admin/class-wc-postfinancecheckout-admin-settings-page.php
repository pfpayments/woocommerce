...
class WC_PostFinanceCheckout_Admin_Settings_Page extends WC_Settings_Page {
	...
	public function get_default_settings() {
		$settings = array(
			array(
				'links' => array(
					'https://plugin-documentation.postfinance-checkout.ch/pfpayments/woocommerce/3.3.15/docs/en/documentation.html' => esc_html__( 'Documentation', 'woo-postfinancecheckout' ),
