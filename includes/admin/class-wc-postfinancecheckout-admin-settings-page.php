...
class WC_PostFinanceCheckout_Admin_Settings_Page extends WC_Settings_Page {
	...
	public function get_settings() {
		...
		$settings = array(
			array(
				'links' => array(
					'https://plugin-documentation.postfinance-checkout.ch/pfpayments/woocommerce/2.0.0-alpha/docs/en/documentation.html' => __( 'Documentation', 'woo-postfinancecheckout' ),
