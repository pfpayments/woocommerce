...
class WC_PostFinanceCheckout_Migration {
	...
	public static function plugin_row_meta( $links, $file ) {
	    if ( WC_POSTFINANCECHECKOUT_PLUGIN_BASENAME === $file ) {
	        $row_meta = array(
	            'docs' => '<a href="https://plugin-documentation.postfinance-checkout.ch/pfpayments/woocommerce/1.7.3/docs/en/documentation.html" aria-label="' . esc_attr__('View Documentation', 'woo-postfinancecheckout') . '">' . esc_html__('Documentation', 'woo-postfinancecheckout') . '</a>',
	        );
