...
class ProductPeriodFee implements ModelInterface, ArrayAccess
{
     ...
     * Sets period_fee
     *
     * @param \PostFinanceCheckout\Sdk\Model\PersistableCurrencyAmount[] $period_fee The amount charged to the customer for each billing cycle during the term of a subscription.
     *
     * @return $this
     */
