...
class SubscriptionPeriodBill implements ModelInterface, ArrayAccess
{
     ...
     * Gets state
     *
     * @return \PostFinanceCheckout\Sdk\Model\SubscriptionPeriodBillState
     */
     ...
     * Sets state
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionPeriodBillState $state The object's current state.
     *
     * @return $this
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionVersion $subscription_version The subscription version that the period bill belongs to.
     *
     * @return $this
     */
