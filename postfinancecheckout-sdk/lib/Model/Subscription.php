...
class Subscription implements ModelInterface, ArrayAccess
{
     ...
     * Gets affiliate
     *
     * @return \PostFinanceCheckout\Sdk\Model\SubscriptionAffiliate
     */
     ...
     * Sets affiliate
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionAffiliate $affiliate The affiliate that led to the creation of the subscription.
     *
     * @return $this
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProductVersion $current_product_version The version of the product that the subscription is currently linked to.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \PostFinanceCheckout\Sdk\Model\SubscriptionState
     */
     ...
     * Sets state
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets subscriber
     *
     * @return \PostFinanceCheckout\Sdk\Model\Subscriber
     */
     ...
     * Sets subscriber
     *
     * @param \PostFinanceCheckout\Sdk\Model\Subscriber $subscriber The subscriber that the subscription belongs to.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \PostFinanceCheckout\Sdk\Model\Token $token The payment token that is used to charge the customer.
     *
     * @return $this
     */
