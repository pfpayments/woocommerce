...
class ProductMeteredTierFee implements ModelInterface, ArrayAccess
{
     ...
     * Sets fee
     *
     * @param \PostFinanceCheckout\Sdk\Model\PersistableCurrencyAmount[] $fee The amount charged to the customer for each consumed unit at the end of a billing cycle.
     *
     * @return $this
     */
     ...
     * Sets metered_fee
     *
     * @param \PostFinanceCheckout\Sdk\Model\ProductMeteredFee $metered_fee The metered fee that this tier belongs to.
     *
     * @return $this
     */
