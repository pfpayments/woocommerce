...
class SubscriptionProductVersionRetirement implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProductVersion $product_version The product version that is to be retired.
     *
     * @return $this
     */
     ...
     * Sets target_product
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProduct $target_product The product to which the subscriptions with the retiring product version are to be migrated. If none is defined, the subscriptions are terminated.
     *
     * @return $this
     */
