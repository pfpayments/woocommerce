...
class ProductPeriodFeeUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets period_fee
     *
     * @param \PostFinanceCheckout\Sdk\Model\PersistableCurrencyAmountUpdate[] $period_fee The amount charged to the customer for each billing cycle during the term of a subscription.
     *
     * @return $this
     */
