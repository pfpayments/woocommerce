...
class Subscriber implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\Address $billing_address The address associated with the subscriber for invoicing and transaction processing purposes.
     *
     * @return $this
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\Address $shipping_address The address to where orders will be shipped.
     *
     * @return $this
     */
