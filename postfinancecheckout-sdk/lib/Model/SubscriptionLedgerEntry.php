...
class SubscriptionLedgerEntry implements ModelInterface, ArrayAccess
{
     ...
     * Sets fee_type
     *
     * @param \PostFinanceCheckout\Sdk\Model\ProductFeeType $fee_type 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \PostFinanceCheckout\Sdk\Model\SubscriptionLedgerEntryState
     */
     ...
     * Sets state
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionLedgerEntryState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \PostFinanceCheckout\Sdk\Model\Tax[] $taxes A set of tax lines, each of which specifies a tax applied to the ledger entry.
     *
     * @return $this
     */
