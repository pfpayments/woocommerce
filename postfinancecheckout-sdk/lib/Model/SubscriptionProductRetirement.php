...
class SubscriptionProductRetirement implements ModelInterface, ArrayAccess
{
     ...
     * Sets product
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProduct $product The product that is to be retired.
     *
     * @return $this
     */
     ...
     * Sets target_product
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProduct $target_product The product to which the subscriptions with the retiring product are to be migrated. If none is defined, the subscriptions are terminated.
     *
     * @return $this
     */
